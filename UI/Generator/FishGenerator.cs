...
/// <summary>
/// Provides asynchronous generation of a large amount of test data for fishes.
/// </summary>
public static class FishGenerator
{
    /// <summary>
    /// Number of records generated by default.
    /// </summary>
    ...
    /// <summary>
    /// Generates a list of random fishes and reports progress to the provided controller.
    /// </summary>
    /// <param name="progressForm">Progress controller that displays the progress to the user.</param>
    /// <param name="cancellationToken">Cancellation token used to abort the generation.</param>
    /// <returns>List of generated fishes.</returns>
